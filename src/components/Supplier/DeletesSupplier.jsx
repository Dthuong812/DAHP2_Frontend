...
import { deleteArraySupplierAPI } from '../../services/apiService';

const DeletesSupplier = ({ selectedRowKeys, fetchData }) => {
    const handleDeleteCategory = async () => {
      ...
      try {
          for (const Supplier of selectedRowKeys) {
              await deleteArraySupplierAPI(Supplier);
...
export default DeletesSupplier